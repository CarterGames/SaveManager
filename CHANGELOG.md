...
### Fixed
- (Contribution: NoixDeXydre) Fixed an issue where user made defaults would no apply as expected in new save files when they were generated. [[GIT-PR#45](https://github.com/CarterGames/SaveManager/pull/45)].
