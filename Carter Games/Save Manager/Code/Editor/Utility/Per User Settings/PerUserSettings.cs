...
namespace CarterGames.Assets.SaveManager.Editor
{
    ...
    public static class PerUserSettings
    {
        ...
        private static readonly string LastSaveObjectTypeNameId = $"{UniqueId}_CarterGames_SaveManager_EditorSettings_LastSaveObjectGenType";
        ...
        /// </summary>
        public static string SaveObjectGenClassName
        {
        ...
        public static int SaveObjectGenType
        {
            get => (int)GetOrCreateValue<int>(LastSaveObjectTypeNameId, SettingType.EditorPref);
            set => SetValue<int>(LastSaveObjectTypeNameId, SettingType.EditorPref, value);
        }
        ...
        /// </summary>
        [MenuItem("Tools/Carter Games/Save Manager/Reset User Editor Settings", priority = 70)]
        public static void ResetPrefs()
        {
            ...
            ShowSaveKeys = false;
            SaveObjectGenClassName = string.Empty;
